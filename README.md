这个分叉仓库已经旧了，对比主仓库已经缺乏很多有用的同步了。我将在2026年7月10日开始继续后续的内容处理。争取改到能用为止(ง •_•)ง
---
(快捷通道祏我不会忘记)https://api.github.com/repos/CoffeePopStudio/Zombie-Run/forks 丨 查看其他分支。<br/>
###由于萌新第一次开始参与代码编辑，如果遇到了某些忽视许可证的改动请提交issus来联系我改正或删库，谢谢!<br/>
---<br/>
这是被AI进行修改的*自用*“分叉”<br/>
#特别的 经过查询分支说明 本仓库由于是分支所以无法被查询到<br/>
所以如果您意外的看到了这个项目 还请您指出不合规的内容以便删改 谢谢<br/>
<br/>
## 我改变了什么<br/>
 - 与原版相同但修复了粒子在paper1.21.111的刷屏报错<br/>
 - 并使用ai加上了配置的注释(当然不知道能不能用了)<br/>
 - 配置内添加了母体设置(额好像也不能用喵)<br/>
 - reset-all 指令 清除部分数据 (编者请看：当你退出游戏是玩家血量可能不对，应该是正常的吧我没测试，还是有别的bug我还没改到。)
 - 游戏开始时传送玩家和母体 到对应重生点(我不知道这是不是修复，或许原版就有吧);
 - 修复在使用/zr spawn 的tab补全越界崩溃;
 - 新增枪械商店GUI与配置
 - 添加了coins永久化相关
 - 添加了coins的管理员命令，管理更便捷
---<br/>
总之，这是个无能的腐竹在使用AI改来改去原版的产物<br/>
确实能用~<br/>
我已经使用了ai查询是否有权限漏洞，当然，如果你不放心的话<br/>
请不要直接使用以及编译，请编译*官方版本*和使用，因为是我自用的东西<br/>
对于直接编译的，*我不负任何由于使用我修改的插件内的新加(删改)条目带来的任何后果！！！！！*<br/>
# *不要用！或慎用！*<br/>
~你也可以无视风险继续安装，毕竟独乐乐不如众乐乐~<br/>
~叠甲部分结束<br/>
---<br/>
如果有什么不对的地方请您
...
- 与 WeaponMechanics crackshot-guns 等等各种枪械插件 联动发放/购买枪械 gun菜单可编辑
- coins持久化 支持管理员删改
- 母体僵尸配置更多更详细。
...
===== 僵尸快跑命令 =====
玩家命令:
/zr shop - 打开枪械商店 (选择你喜欢的枪械)
/zr coins - 查看你的硬币余额
/zr coins <玩家> - 查看他人硬币余额
/zr transfer <玩家> <金额> - 转账硬币给其他玩家
/zr reset-select - 清除你的枪械选择
/zr lobby - 返回大厅

管理员命令:
/zr start - 开始游戏
/zr spawn add <名称> <类型> - 添加重生点
/zr spawn remove <名称> - 删除重生点
/zr spawn list - 列出重生点
/zr doors add ... - 添加门
/zr doors remove <名称> - 删除门
/zr doors list - 列出所有门
/zr buttons add ... - 添加按钮
/zr buttons remove <名称> - 删除按钮
/zr buttons list - 列出所有按钮
/zr reload - 重载配置
/zr open - 开始游戏
/zr close - 结束游戏
/zr coins set <玩家> <金额> - 设置玩家硬币
/zr coins add <玩家> <金额> - 给玩家添加硬币
/zr coins take <玩家> <金额> - 扣除玩家硬币
/zr reset-all - 清除所有玩家身份与部分游戏数据(保留硬币)
